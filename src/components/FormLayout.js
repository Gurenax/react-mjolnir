  ...
  return (
    <div className="slds-form slds-form_stacked">
      <div className="slds-form-element">
        <label className="slds-form-element__label" for="input-id-01">Text Input</label>
        <div className="slds-form-element__control">
          <input type="text" id="input-id-01" className="slds-input" placeholder="Placeholder Text" />
        </div>
      </div>
      <div className="slds-form-element">
        <label className="slds-form-element__label" for="input-id-02">Textarea Label</label>
        <div className="slds-form-element__control">
      ...
      <fieldset className="slds-form-element">
        ...
        <div className="slds-form-element__control">
          <span className="slds-checkbox">
            ...
            <label className="slds-checkbox__label" for="checkbox-3">
          ...
          <span className="slds-checkbox">
            ...
            <label className="slds-checkbox__label" for="checkbox-4">
              <span className="slds-checkbox_faux"></span>
      ...
      <fieldset className="slds-form-element">
        ...
        <div className="slds-form-element__control">
          <span className="slds-radio">
            ...
            <label className="slds-radio__label" for="radio-3">
          ...
          <span className="slds-radio">
            ...
            <label className="slds-radio__label" for="radio-4">
              <span className="slds-radio_faux"></span>
